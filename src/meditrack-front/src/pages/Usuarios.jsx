...
<div className="container">
    ...
    <div className="summary-chart-container" onClick={() => setFiltrosRoles([])} style={{ cursor: 'pointer' }}>
    ...
    <div style={{ display: 'flex', alignItems: 'center', gap: '15px', marginBottom: '20px', width: '100%' }}>
        ...
        <button 
            style={{ padding: '10px 20px', backgroundColor: '#10b981', color: 'white', border: 'none', borderRadius: '8px', fontWeight: 'bold', cursor: 'pointer', whiteSpace: 'nowrap' }} 
    ...
    <table style={{ width: '100%', borderCollapse: 'collapse' }}>
        ...
        <tr>
            ...
            <th style={{ textAlign: 'left', paddingBottom: '10px' }}>Estado</th>
