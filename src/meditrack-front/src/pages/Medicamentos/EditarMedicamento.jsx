...
function EditarMedicamento() {
    ...
    const handleGuardar = async () => {
        ...
        try {
            const { id: _id, imagenUrl: _url, ...campos } = form;
            ...
            else setErrorGeneral(err.message || 'Error al actualizar medicamento.');
        }
    };
